...
| FR-18 | 사용자는 주가 차트를 캔들/라인, 기간(30·90·180일)으로 조회하고 MA·거래량·볼린저·RSI·MACD를 토글할 수 있어야 한다. | Should | GET /api/chart/{code} |
| FR-19 | 시스템은 차트 지표를 종합한 기술적 분석 해석(추세·크로스·모멘텀·과열도)을 제공해야 한다. | Should | 규칙 기반, 참고용 |
